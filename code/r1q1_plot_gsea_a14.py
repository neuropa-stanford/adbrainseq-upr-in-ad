#!/usr/bin/env python3
"""GSEA NES heatmap — single panel (former panel a), terms 1-14 only.
...
Rank metric = sign(log2FC) x -log10(P) (Nativio: Welch t). Output: R1Q1_UPR_GSEA_a14.{png,svg}
"""
...
for ext in ("png", "svg"):
    fig.savefig(os.path.join(OUT, f"R1Q1_UPR_GSEA_a14.{ext}"),
                dpi=300 if ext == "png" else None, facecolor="white", bbox_inches="tight")
print("saved R1Q1_UPR_GSEA_a14.{png,svg}")
